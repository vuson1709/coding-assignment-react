...
function addProjectDependencies(tree, options) {
    ...
    const frameworkDependencies = {
        ...
        connect: {
            connect: versions_1.connectVersion,
            '@types/connect': versions_1.connectTypingsVersion,
        },
    };
...
function updateTsConfigOptions(tree, options) {
    ...
    (0, devkit_1.updateJson)(tree, `${options.appProjectRoot}/tsconfig.app.json`, (json) => (Object.assign(Object.assign({}, json), { compilerOptions: Object.assign(Object.assign({}, json.compilerOptions), { esModuleInterop: true }) })));
}
function applicationGenerator(tree, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (options.framework && (options === null || options === void 0 ? void 0 : options.bundler) === 'esbuild') {
...
function normalizeOptions(host, options) {
    ...
    return Object.assign(Object.assign({}, options), { name: (0, devkit_1.names)(appProjectName).fileName, frontendProject: options.frontendProject
        ...
        parsedTags, linter: (_a = options.linter) !== null && _a !== void 0 ? _a : linter_1.Linter.EsLint, unitTestRunner: (_b = options.unitTestRunner) !== null && _b !== void 0 ? _b : 'jest', port: (_c = options.port) !== null && _c !== void 0 ? _c : 3000 });
}
