...
async function vitestGenerator(tree, schema) {
    ...
    var _testTarget, ref2;
    let testTarget = (ref2 = (_testTarget = schema.testTarget) != null ? _testTarget : (ref = (0, _generatorUtils.findExistingTargetsInProject)(targets)) == null ? void 0 : (ref1 = ref.validFoundTargetName) == null ? void 0 : ref1.test) != null ? ref2 : 'test';
