...
exports.writeIndexHtml = exports.augmentIndexHtml = void 0;
...
function augmentIndexHtml(params) {
    ...
    const indexSource = new webpack.sources.ReplaceSource(new webpack.sources.RawSource(params.inputContent), params.input);
    let scriptElements = '';
...
function writeIndexHtml({ outputPath, indexPath, files = [], moduleFiles = [], baseHref, deployUrl, sri = false, scripts = [], styles = [], postTransform, crossOrigin, }) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        content = augmentIndexHtml({
            ...
            loadOutputFile: (filePath) => (0, fs_1.readFileSync)((0, path_1.join)((0, path_1.dirname)(outputPath), filePath)).toString(),
        });
        if (postTransform) {
