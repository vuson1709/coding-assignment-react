...
const webpack = (storybookWebpackConfig = {}, options) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const builderOptions = Object.assign(Object.assign({}, options), { root: options.configDir, 
        ...
        projectRoot: '', sourceRoot: '', fileReplacements: [], sourceMap: {
            hidden: false,
            scripts: true,
            styles: true,
            vendors: false,
    ...
    const configure = (0, config_1.composePlugins)((0, webpack_2.withNx)({ skipTypeChecking: true }), (0, webpack_2.withWeb)(), (0, with_react_1.withReact)());
    ...
    return mergeWebpack.merge(Object.assign(Object.assign({}, storybookWebpackConfig), { module: Object.assign(Object.assign({}, storybookWebpackConfig.module), { rules: [
                ...
                .plugins) !== null && _c !== void 0 ? _c : [])) }), plugins: (0, merge_plugins_1.mergePlugins)(new webpack_1.DefinePlugin(getClientEnvironment(storybookWebpackConfig.mode).stringified), ...((_d = storybookWebpackConfig.plugins) !== null && _d !== void 0 ? _d : []), ...((_e = finalConfig.plugins) !== null && _e !== void 0 ? _e : [])) }), resolvedEmotionAliases);
});
