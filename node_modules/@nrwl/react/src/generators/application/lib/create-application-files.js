...
function createApplicationFiles(host, options) {
    ...
    const relativePathToRootTsConfig = (0, typescript_1.getRelativePathToRootTsConfig)(host, options.appProjectRoot);
