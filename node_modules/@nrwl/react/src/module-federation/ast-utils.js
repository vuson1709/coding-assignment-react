...
function addRemoteToConfig(source, app) {
    const assignments = (0, typescript_1.findNodes)(source, ts.SyntaxKind.PropertyAssignment);
    ...
    const binaryExpressions = (0, typescript_1.findNodes)(source, ts.SyntaxKind.BinaryExpression);
