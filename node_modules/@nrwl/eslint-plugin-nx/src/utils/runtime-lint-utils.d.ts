import { ProjectGraph, ProjectGraphDependency, ProjectGraphExternalNode, ProjectGraphProjectNode } from '@nrwl/devkit';
...
declare type SingleSourceTagConstraint = {
    sourceTag: string;
...
declare type ComboSourceTagConstraint = {
...
export declare type DepConstraint = SingleSourceTagConstraint | ComboSourceTagConstraint;
