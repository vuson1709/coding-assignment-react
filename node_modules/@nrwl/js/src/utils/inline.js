...
exports.postProcessInlinedDependencies = exports.handleInliningBuild = exports.isInlineGraphEmpty = void 0;
...
function recursiveUpdateImport(dirPath, importRegex, inlinedDepsDestOutputRecord) {
    ...
    for (const file of files) {
        ...
        if (file.isFile() &&
            ...
            recursiveUpdateImport((0, path_1.join)(dirPath, file.name), importRegex, inlinedDepsDestOutputRecord);
        }
    }
}
